...
const schemaPostUsuario = yup.object({
    body: yup.object({
        ...
        permissao: yup.string().oneOf(['criador', 'estudante'], "Permissão invalida").required("A permissão é obrigatoria")
    }),
})
...
usuarioRouter.get('/', usuariosControllers.index
    /*
        ...
        #swagger.description = 'Endpoint para listar usuarios cadastrados'
